...
"""
    ...
    body.append(f"""        <div class="compact-booking-cta" style="color:#1f2937;background: #f0f4ff; border-left: 4px solid #2563eb; padding: 24px 28px; border-radius: 8px; margin-top: 32px;">
