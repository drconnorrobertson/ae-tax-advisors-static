...
### September 24, 2026 — Pending publication/indexing gate: fixed partner payment filed as a distribution
...
- Publication/indexing: pending deployment, production verification, IndexNow, and authenticated Search Console inspection/sitemap workflow. Do not increment the 67 accepted-target count before those gates are reported.
