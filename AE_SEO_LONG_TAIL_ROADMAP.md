...
### September 24, 2026 — Pending publication/indexing gate: wrong rental depreciation start date
...
- Publication/indexing: pending deployment, production verification, IndexNow, and Search Console inspection/sitemap workflow. Do not increment the 67 accepted-target count until these gates are reported.
