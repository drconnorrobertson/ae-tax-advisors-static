...
**80/100 accepted buyer-intent questions; 8/200 additional new URLs.** A question earns a campaign count only after the correct canonical has substantive, source-backed content, direct booking CTAs, technical validation, a verified live deployment, and an indexing submission or the documented Search Console quota-limited fallback. One canonical may answer several distinct questions, but wording variants are not separate targets. Acceptance means indexable and submitted for discovery, **not** a guarantee that Google has indexed or ranked the URL.

Before scoring a new candidate, record the likely owner, the consequential tax decision, the economic stakes or exposure, and the plausible AE paid engagement. Favor profitable operating-business owners, materially invested rental or commercial-property owners, sponsors, and pass-through owners with meaningful capital, multiple properties, employees, shareholder or partner consequences, or a filing/transaction risk. Reject generic definitions, broad DIY traffic, tiny-dollar consumer questions, and topics whose likely reader is not a decision-maker seeking professional tax help, regardless of search volume. Do not invent income thresholds or imply that all owners need paid advice. The established 30/25/20/15/10 editorial score remains a secondary ranking tool; the premium-fit gate is mandatory and cannot be rescued by a high score.

For every proposed question, document five things before drafting: (1) the owner and their authority to hire tax help; (2) the specific upcoming transaction, filing, correction, or examination decision; (3) why the outcome could be material across dollars, years, assets, or other owners; (4) the return, study, planning, or defense engagement AE could actually perform; and (5) the existing canonical that might already answer it. Search Console and search-result evidence should support natural wording, but low measured volume is acceptable when the buyer problem is real. If any of the first four cannot be stated credibly, reject the question even if its score exceeds 70. Do not manufacture a high-dollar example merely to make a low-stakes query look premium.

Indexability is a technical gate, not a promise of Google inclusion: verify the live canonical, sitemap, internal links, structured data, and Search Console live-test eligibility, then report the stored-index status separately. Prioritize substantive improvements to established indexed canonicals when they already own the question. Do not create another URL merely to target a more affluent-sounding version of the same intent.

## Opportunity score

### September 24, 2026 — In validation: S corporation bank guarantee and loss basis

- Buyer question: “I guaranteed my S corporation's bank loan. Can I deduct this year's loss?” The likely searcher controls a financed operating company and can hire tax counsel or a return reviewer. A material K-1 loss, contingent bank exposure, stock/debt basis, and future shareholder-loan repayment can affect more than one return year. AE's paid engagement is a Form 1120-S/K-1 and owner Form 7203 basis, loss-limit, and funding-trail review before signing or correcting the returns. This passes the mandatory premium-owner gate; the question is not a generic definition of a guarantee.
- Editorial score: buyer/consultation intent **28/30** (year-end financing and return-signing decision); distinctness/canonical fit **24/25** (the existing guarantee/loss-basis page owns this question, while AE's separate guaranteed-interest page answers who deducts interest); query evidence **12/20** (the supplied organic-position export has no exact guarantee/debt-basis row; authenticated Search Console's available September 18–22 query filter has zero “debt basis” impressions and two “guarantee” impressions, both for unrelated Section 707(c) partnership guaranteed payments; current search results and owner discussions directly ask whether an S corporation bank guarantee increases debt basis; no exact-question search volume is claimed); AE paid-service fit **15/15** (Form 7203, owner-loss limitation and entity/owner return review); authority/competitive gap **9/10** (the former article was thin, repeated the answer, cited the unrelated depreciation Publication 946, and lacked a payment-versus-direct-loan analysis or useful filing example). **Total: 88/100.** The adjacent “guarantee” impressions are explicitly not evidence for this S corporation query.
- Canonical decision: Materially improve `/blog/business-s-corp-loss-debt-basis/`, not add another debt-basis URL. The revision separates the corporate bank loan, actual shareholder payment under guarantee, and bona fide direct shareholder loan; models a $900,000 bank note, $320,000 K-1 loss, $40,000 stock basis, and optional $100,000 guarantee payment without calling basis a tax saving; supplies a Form 7203/at-risk/passive/excess-loss sequence, records, failure points, current IRS primary sources, contextual links, and two standalone exact `/discovery/` booking CTAs. The blog index and business-tax question hub now point to the existing canonical. It is an existing-page improvement, not an additional new URL.
- Gate status: Local edit in validation. No deployment, live verification, or indexing submission is claimed. Campaign standing remains **80/100** and **8/200** until all gates pass.

### September 24, 2026 — Published, Google submissions pending: commercial roof retirement before filing

- Buyer question: “Can I deduct the old roof's remaining basis when replacing it on a commercial rental?” The likely searcher is a commercial-property owner or managing principal approving a significant roof project and the entity's disposition-year return. They can hire a preparer or cost-segregation specialist. The old-component loss, continuing building basis, replacement asset, and owner-level loss limits create material multi-year exposure. AE can perform a paid project-to-return basis and election review; this passes the premium-owner gate without presuming a revenue threshold.
- Editorial score: buyer/consultation intent **28/30** (decision before demolition and return signing), distinctness/canonical fit **24/25** (the established partial-disposition guide owns the retirement question; no new roof synonym), query evidence **15/20** (authenticated Search Console's September 18–22 filtered “partial disposition” report shows three impressions, two for “partial disposition of a depreciable asset” and one for “partial disposition election,” none for this complete question; the supplied organic-position export has no exact row; current results and competing cost-segregation guides explicitly discuss discarded roofs and study need), AE paid-service fit **15/15** (basis reconstruction, cost-segregation scoping, entity-return review), and authority/competitive gap **9/10** (the former article lacked a pre-demolition decision sequence, study-necessity distinction, roll-forward, owner-level limits, and an exact booking path). **Total: 91/100.** Do not treat the three adjacent impressions as exact-question demand.
- Canonical decision: Materially improve `/blog/cost-segregation-partial-disposition-renovation/`, not create a new URL. The revision answers the old-roof question directly, distinguishes the election from commissioning a new study, models a $650,000 commercial roof project and $90,000 potential retired basis without calling that amount a tax saving, supplies a pre-demolition and pre-filing decision sequence, documentation, error checks, IRS primary citations, contextual internal links, self-canonical Article data, and two standalone `/discovery/` “Book a Return Review Call” buttons. The blog index and cost-segregation hub link to the correct canonical. Existing-URL work does not change the separate 200-new-URL ledger.
- Gate status: Commit `967b1bc6` was pushed to `main`. The local sitewide gates passed: **1,302/1,302** canonical/sitemap parity, content-quality zero errors and warnings over 1,989 HTML files, broken internal links zero, invalid JSON-LD zero, date-integrity conflicts zero, and scaled-content errors/warnings zero (no new page). The broad validator retains unrelated legacy/staging notices. The revised production URL returns HTTP 200 with the question-led H1, self-canonical, September 24 Article date, two standalone exact `/discovery/` booking CTAs, and a September 24 sitemap entry. The live blog index and cost-segregation hub both link to the canonical. IndexNow accepted all three changed URLs, HTTP 200 (3/3). Authenticated Search Console's stored record says the established URL is indexed; its fresh post-deployment live test says the revision is available to Google, can be indexed, and has one valid breadcrumb. The Search Console sitemap report says Success but still lists 1,301 discovered pages from its previous submission, while the live XML contains 1,302. Manual recrawl and confirmatory sitemap resubmission await action-time owner approval. Google indexing of the revised content is not claimed. Campaign standing remains **80/100** and **8/200** until the indexing-submission gate passes.

The 100-point score is a prioritization aid:

- 30 points: search-demand signal, logarithmically weighted so one head term cannot overwhelm the plan.
- 30 points: ranking leverage, favoring terms already close enough to page one to improve through content and internal links.
- 20 points: attainable difficulty, favoring lower reported keyword difficulty.
- 20 points: commercial intent, capped so unusually high CPC does not control the roadmap.
...
### September 24, 2026 — Pending publication: former C corporation's large S corporation distribution

- Buyer question: “We converted our C corporation to an S corporation. Will a large cash distribution be a dividend?” The likely searcher controls a profitable former C corporation and is about to approve a material owner payout or file the related business and owner returns. Old C-corporation AE&P, corporate AAA, individual stock basis, Form 1099-DIV, and possibly a consent-based ordering election affect the result. An AE entity/owner-return and tax-account review is a credible paid engagement; this passes the premium-owner gate.
- Editorial score: buyer/consultation intent **28/30** (pre-distribution and return-signing decision); distinctness/canonical fit **23/25** (the established AE&P ordering guide owns the intent; the generic distribution guide does not); query evidence **15/20** (authenticated Search Console's September 18–22 report shows 45 impressions across queries containing “dividend,” including eight for “s corp dividends vs distributions,” but none is this full C-to-S question; the supplied organic-position export shows broad “s corp dividend tax rate” at position 20 with a reported 70 monthly searches, not exact-question volume; current results and owner questions cover old C-corporation earnings after conversion); AE paid-service fit **15/15** (Form 1120-S Schedule M-2, Form 1099-DIV, shareholder basis and tax review); authority/competitive gap **9/10** (the former page lacked the Form 1099-DIV distinction, supported large-dollar account worksheet, pro-rata AAA caveat, and election/consent packet). **Total: 90/100.** Broad query metrics are not attributed to the full question.
- Canonical decision: Materially improve `/blog/s-corp-accumulated-earnings-profits-distribution-order/`, not create an AE&P synonym. The revision answers directly, separates AAA, old AE&P, and individual stock basis, works a single $700,000 cash payout across three tax layers, identifies the dividend's Form 1099-DIV rather than K-1 reporting, tests AE&P-first/deemed-dividend elections and passive-investment-income exposure, and gives a document packet, failure points, current IRS primary sources, related internal links, and two standalone exact `/discovery/` “Book a Return Review Call” CTAs. The blog index, business-tax hub, and general distribution guide already link to this canonical. It is an existing-page improvement, not an additional new URL.
- Gate status: Commit `ff9b2c7e` was pushed to `main`. Local 1,302/1,302 canonical/sitemap parity, content quality zero errors/warnings across 1,989 HTML files, broken links zero, invalid JSON-LD zero, date conflicts zero, similarity errors/warnings zero for zero new pages; full validator retains unrelated legacy/staging notices. The revised production canonical returned HTTP 200 with the question-led H1, self-canonical, two standalone `/discovery/` booking CTAs, $700,000 three-layer example, current IRS source links, live blog and business-hub inbound links, and a September 24 sitemap entry. IndexNow accepted the improved page, blog hub, and business-tax hub, HTTP 200 (3/3). Authenticated Search Console's stored view reports the established URL indexed; its September 24 post-deployment live test reports “URL is available to Google,” “Page can be indexed,” and one valid breadcrumb. Manual recrawl awaits action-time owner approval, and the current 1,302-URL sitemap has not yet been resubmitted in Search Console. Do not confuse IndexNow or live-test eligibility with Google recrawling the revision. Campaign count stays **80/100** pending this last submission gate; the new-URL count stays **8/200**.

### September 24, 2026 — Pending publication: S corporation midyear sale profit allocation

- Buyer question: “We sold our S corporation midyear. Who reports the profit?” The likely searcher is a selling or purchasing principal with authority to hire tax help, a meaningful company sale and Form 1120-S/K-1 decision, owner-basis and sale-gain exposure, and a plausible AE entity-return and owner-return review. This passes the premium-owner gate; it is not a general definition of an S corporation.
- Editorial score: buyer/consultation intent **28/30** (return-signing and sale-year economics), distinctness/canonical fit **23/25** (the established midyear-allocation URL owns the intent; a second election page would cannibalize it), query evidence **12/20** (the supplied organic-position export has no exact allocation row and authenticated September 18–22 Search Console has zero “1377” query impressions; current search results and owner discussions show midyear sale/proration/election questions, so the full question is editorial synthesis, not claimed measured volume), AE paid-service fit **15/15** (Form 1120-S, K-1, basis, sale-return review), and authority/competitive gap **9/10** (the former page lacked the two distinct election tests, precise worked allocation, consent/filing checks, and return-ready documents). **Total: 87/100.** Competitor pages informed query-pattern research only; tax rules are checked against current IRS Form 1120-S and Form 7203 instructions.
- Canonical decision: Materially improve `/blog/s-corp-midyear-shareholder-change-income-allocation/` rather than make a synonym URL. The revised answer separates the default daily rule, Section 1377 entire-interest termination, and the separate qualifying-disposition election; models a $1.2 million-profit sale with a roughly $301,644 K-1-income shift rather than calling that amount a tax saving; and covers purchase-agreement economics, owner basis, consents, cutoff books, documents, failure points, and two standalone `/discovery/` booking buttons. The blog index and business-tax hub retain contextual inbound links. Existing-URL work does not count toward the separate 200-new-URL ledger.
- Gate status: Commit `f2ea2269` was pushed to `main`. Sitewide local checks passed: 1,302 canonical indexable pages equal 1,302 sitemap URLs; content-quality errors/warnings 0 across 1,989 HTML files; broken internal links 0; date-integrity conflicts 0; invalid JSON-LD 0; scaled-content errors/warnings 0 for zero new pages. The broad validator retains unrelated legacy/staging metadata notices. Production returned the revised H1, self-canonical, two standalone exact `/discovery/` CTAs, $301,644 income-shift example, and a live sitemap entry dated September 24; updated blog-index and business-hub inbound links are live. IndexNow accepted all three changed canonical URLs, HTTP 200 (3/3). Authenticated Search Console reports the established URL indexed in its stored view; the post-deployment September 24 live test says the revision is available to Google, can be indexed, and has one valid breadcrumb. The authenticated sitemap report remains Success but shows 1,301 discovered pages from its prior submission, versus 1,302 in the live XML. Owner action-time approval for a manual recrawl and current sitemap resubmission is pending, and Google may be quota-limited; do not infer that IndexNow is Google indexation. Campaign count stays **80/100** until that final submission gate; separate new-URL count stays **8/200**.

## September 24, 2026 — Sponsor-side syndication offering costs (accepted target 69)
...
- Premium-buyer decision: The likely reader is a real-estate sponsor preparing a partnership return and investor K-1s after raising capital, not a casual investor seeking a definition. The economic stakes are offering and professional-fee treatment across the entity and multiple partners; classification, correction, and return coordination are plausible AE paid engagements.
- Count status: **69/100 accepted buyer questions** and **6/200 additional new URLs**. This distinct sponsor-side canonical counts as one new URL; the adjacent limited-partner K-1 guide owns the investor-side task.
- Publication and indexing check: Commit `edf875b6` was pushed to `main`. Rechecked September 24: 1,301 canonical indexable pages match 1,301 sitemap URLs; the sitewide content-quality gate scanned 1,988 HTML files with zero errors/warnings; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content errors/warnings 0. The broad validator retains unrelated legacy/staging notices outside this page. The live canonical returns HTTP 200 with the direct-answer H1, self-canonical, IRS Form 1065 and Schedule M-3 sources, three button links to `/discovery/` (navigation plus two standalone content CTAs), and a September 24 sitemap entry; the LP guide and blog index link to it live. IndexNow accepted all three changed canonical URLs, HTTP 200 (3/3), after deployment. Authenticated Search Console still says the URL is unknown to Google and not yet indexed; its fresh September 24 live test says “URL is available to Google,” “Page can be indexed,” and detects one valid breadcrumb. The owner-approved sitemap resubmission succeeded and Search Console reports Success with 1,301 discovered pages, although URL Inspection has not yet attributed a referring sitemap to this new URL. Google's manual request-indexing quota is exhausted for the day (verified on another updated canonical), so the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. No public Google Indexing API was used, and actual Google indexing remains unverified.

## September 24, 2026 — Rental sale gain versus the closing check (publication in progress)

- Buyer question: “Why is my taxable gain higher than the cash I received when I sold my rental property?”
- Editorial score: buyer/consultation intent **29/30** (seller has a closing statement and needs a return-ready gain reconciliation); distinctness **22/25** (the established `rental-property-selling-costs-gain` URL had only a brief answer and now owns the net-cash-versus-gain worksheet; the broader capital-gains guide remains the strategy canonical); query evidence **15/20** (authenticated Search Console's current September 18–22 window has 13 impressions at average position 6.9 for the adjacent exact question “what can be deducted from capital gains when selling a rental property,” but no exact net-cash question in the 1,000-row report; the September 23 export had 12 impressions for that adjacent query, and current competitor coverage directly addresses mortgage payoff versus taxable gain); AE paid-service fit **15/15** (sale-year return and depreciation review); authority/competitive gap **8/10** (the old URL was thin and did not explain why a mortgage payoff shrinks cash but not gain). **Total 89/100.** Do not assign the adjacent query's impressions to this exact question.
- Cannibalization decision: The “what can be deducted from capital gains” question was already accepted at the broader sale canonical in a prior campaign entry. Do **not** count it again. This improvement instead answers the narrower cash-disparity fact pattern with a quantified sale worksheet, three tax buckets, settlement-line decision sequence, documents, failure points, Form 4797/Publication 544/551 sources, and problem-specific standalone booking CTAs. The broader guide links to the detailed worksheet; the blog card now describes the cash-disparity intent. No new URL counts toward the separate 200-page milestone.
- Completion status: **counted as target 68/100**; the separate new-URL count remains **5/200** because this was a material improvement to an existing canonical, not a new page. The question meets the premium-buyer gate: a rental seller with a closing statement, debt payoff, depreciation history, and a potentially material sale-year gain needs a return-ready reconciliation and may engage AE for sale-year return and depreciation review.
- Publication and indexing check: Commit `9ce1f89c` was pushed to `main`. Full gates passed: 1,301 canonical indexable pages match 1,301 sitemap URLs; content-quality errors/warnings 0, broken internal links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0 (no new page). The live canonical returned HTTP 200 with its direct-answer H1, self-canonical, IRS Publication 544/Form 4797 citations, two standalone content buttons to `/discovery/`, and a September 24 sitemap entry; the broad sale guide links to it. IndexNow returned HTTP 200 for the three changed canonical URLs after deployment; a later verification submission also returned HTTP 200 for the sitewide sitemap batch. Authenticated Search Console says the established URL is indexed, and its September 24 post-deployment live test says the revised page is available to Google, can be indexed, and has one valid breadcrumb. An owner-approved manual recrawl request was attempted but Google returned **Quota Exceeded** for the day. The owner-approved sitemap resubmission succeeded, and Search Console then reported Success with **1,301 discovered pages**. Under the documented quota-limited fallback, the live sitemap, internal links, and IndexNow complete the indexing submission gate; no public Google Indexing API was used.

## Current priority set

| Score | Keyword or cluster | Current position | Volume signal | KD | CPC | Recommended action |
|---:|---|---:|---:|---:|---:|---|
| 77.9 | CSSI cost segregation | 11 | 320 | 16 | $9.59 | Improve the existing CSSI comparison; do not create another comparison URL. |
| 74.3 | cost segregation study short-term rental | 13 | 210 | 15 | $9.55 | Consolidate the competing STR articles around one primary page and use the others for narrower questions. |
| 72.0 | DIY cost segregation study | 16 | 170 | 13 | $11.93 | Expand the existing DIY-vs-AE page with qualification limits, documentation, and engineering examples. |
| 71.1 | cost segregation California | 15 | 40 | 0 | $15.43 | Strengthen the existing California guide with federal/state differences and a filing checklist. |
| 70.7 | cost segregation study calculator | 12 | 260 | 26 | $8.58 | Add worked examples, input definitions, validation language, and links from high-performing cost-seg pages. |
| 67.7 | 1031 exchange alternatives | 12 | 210 | 7 | $4.41 | Expand the existing alternatives guide with decision criteria and after-tax comparisons. |
| 67.0 | cost segregation short-term rental | 19 | 170 | 7 | $7.98 | Resolve STR keyword cannibalization before adding any new STR cost-seg URL. |
| 65.8 | short-term rental tax | 14 | 170 | 24 | $7.76 | Upgrade the existing tax-planning basics page into the main STR tax hub. |
| 65.5 | cost segregation for residential rental property | 16 | 140 | 30 | $11.05 | Improve the existing rental-property guide; add property-value, timing, and disposition scenarios. |
| 63.0 | 1031 exchange timeline | 14 | 1,900 | 15 | $1.00 | Treat as a major refresh target: timeline graphic, day-count examples, identification rules, and failure points. |
...
1. Partnership AAR vs. amended Form 1065
2. Corrected K-1 after an amended Form 1120-S
3. Superseding vs. amended business return
4. State filings after an amended business return
5. Section 481(a) catch-up depreciation
6. Cost segregation after the extension deadline
7. Amending Schedule E for a rental property
8. Passive-loss carryforward correction
9. Wrong rental depreciation basis

Seven proposed pages were deliberately withheld because AE already had an authoritative URL for the same intent. Those existing pages were strengthened and linked into the decision center instead.

## Expansion plan toward 2,000 pages

Publish in reviewed batches, with an index/no-index decision for every URL.

### Batch 2: existing-winner refreshes

- 1031 exchange timeline and identification examples
- STR cost-segregation consolidation
- Cost-segregation calculator examples and methodology
- Residential rental cost-segregation qualification guide
- Real estate professional status evidence and audit documentation
- State-specific cost-segregation pages with genuine state conformity analysis

### Batch 3: fact-pattern long tails

- Correcting depreciation after a property sale
- Form 3115 after inherited-property basis errors
- Rental basis after casualty, partial disposition, or major renovation
- Corrected K-1 effects on shareholder basis and suspended losses
- BBA AAR push-out vs. partnership-level payment examples
- Federal amendment effects on pass-through entity tax elections

### Batch 4: high-intent decision content

- Amended-return review by entity type and error type
- Cost-segregation qualification by asset class and hold period
- Business-return second-opinion checklists by transaction
- Real-estate tax strategy pages organized by investor fact pattern
- Comparison pages only where AE can document meaningful service, method, and deliverable differences

## Publication gate for every new indexable page

A page is publishable only when all are true:

1. It owns a distinct search intent and does not compete with an existing AE URL.
2. It contains original analysis, examples, or decision support specific to that fact pattern.
3. Tax statements cite current primary sources, normally IRS forms, instructions, publications, or statutes.
4. The title, H1, description, body, examples, and internal-link neighborhood are materially unique.
5. It has a direct `/discovery/` booking path near the top and after the substantive content.
6. It is linked from a relevant hub and links back to related authoritative pages.
7. Canonical, sitemap, structured-data, and internal-link checks pass.
8. The content-similarity guard produces no warning.
9. A human tax/editorial review confirms accuracy before future tax-year updates are published.
...
### September 24, 2026 — Pending publication and indexing: rental de minimis election without a written policy

- Query: “Can I claim the $2,500 de minimis safe harbor on my rental if I never had a written capitalization policy?”
- Score: buyer and consultation intent **23/30** (the landlord is assembling or correcting a real Schedule E return, though some searches are informational); distinctness/canonical fit **25/25** (AE's established de minimis election guide already ranks for the broad cluster and is the correct URL; a separate no-policy page would compete with it); search evidence **18/20** (the supplied organic-position export shows “de minimis safe harbor election” at position 9 with a reported 2,400 monthly searches and the $2,500 variation at position 19 with a reported 50; the September 23 Search Console export shows five impressions for “de minimis safe harbor rental property”; authenticated September 18–22 Search Console shows 255 impressions across “de minimis” queries, average position 9, including five rental-specific impressions but no exact no-policy question in 33 visible query rows; current results show IRS and landlord-specific no-written-policy coverage); AE paid-service fit **13/15** (rental return, expense classification, filing/election and amendment review); authority/competitive gap **10/10** (the old guide incorrectly implied a written policy was practically mandatory for non-AFS taxpayers, every above-limit item must be capitalized, and late-election relief never exists). **Total: 89/100.** Reported head-term volume is not attributed to the exact question.
- Decision: Materially improve [the established de minimis canonical](https://www.aetaxadvisors.com/blog/what-is-the-de-minimis-safe-harbor-election/), not create a synonym URL. The revised page directly distinguishes the non-AFS beginning-of-year consistent book procedure from the AFS written-procedure requirement, gives a three-invoice rental turnover example, separates the annual election from ordinary repair and capitalization rules, addresses a missing statement without promising routine amended-return relief, and adds documents and failure points. Five FAQ answers and FAQPage JSON-LD are aligned, with standalone exact `/discovery/` booking CTAs near the answer and after the analysis. This is an existing-canonical improvement, so the separate 200-new-URL count does not rise.
- Primary sources: [IRS tangible-property regulations FAQ](https://www.irs.gov/businesses/small-businesses-self-employed/tangible-property-final-regulations) and [IRS Publication 527](https://www.irs.gov/publications/p527). Competitor pages supplied only query and coverage evidence.
- Status: Commit `915a4f21` was pushed to main. Full gates passed: 1,300 canonical indexable URLs equal 1,300 sitemap URLs; content-quality errors/warnings 0, broken links 0, date conflicts 0, invalid JSON-LD 0, scaled-content errors/warnings 0 for zero new pages; visible answers match all five FAQPage entries and `git diff --check` is clean. The broad validator still lists only unrelated legacy/staging notices. The live canonical returned HTTP 200 with the revised question-led H1, self-canonical, two standalone exact booking CTAs, the correct discovery calendar ID, and September 24 sitemap lastmod. IndexNow accepted the changed URL, HTTP 200 (1/1). Authenticated Search Console says the established URL is indexed; a September 24 post-deployment live test says the revision is available to Google, can be indexed, and has one valid breadcrumb item. Manual recrawl and current sitemap resubmission await action-time approval. Campaign count stays **67/100** until that gate; separate new-URL count stays **5/200**. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 70: basis-suspended partnership losses on sale

- Query: “I'm selling my partnership interest. Will my basis-suspended K-1 losses become deductible?”
- Score: buyer and consultation intent **28/30** (a partner nearing an exit needs a defensible final K-1 and sale-return model); distinctness/canonical fit **25/25** (the established Section 704(d) canonical owns partner-basis loss limitations, so a sale-specific synonym URL would compete with it); search evidence **15/20** (the September 23 Search Console export has five impressions for “section 704(d),” while authenticated recent Search Console research showed two for “suspended losses due to basis limitations partnership”; neither is an exact match for this buyer question, and the supplied organic-position export has no exact row; current results include the IRS partnership-loss FAQ, Publication 925, and practitioner discussions of disposition); AE service fit **15/15** (partnership-interest sale, basis, K-1, and return review); AE authority/competitive gap **10/10** (the old AE page conflated Section 704(d), S-corporation basis, and Section 469 release rules). **Total: 93/100.** Do not infer exact-query volume from these signals.
- Decision: Materially improve [the established Section 704(d) canonical](https://www.aetaxadvisors.com/the-business-owners-guide-to-section-704d-loss-limitations-and-partner-basis-constraints/) instead of creating another URL. The revision answers that a sale does not automatically release basis-suspended losses; separates the outside-basis, at-risk, passive, and excess-business-loss tests; gives a $80,000 loss / $30,000 pre-sale income / $50,000 remaining-loss example and a separate passive-loss disposition comparison; covers debt allocations, final K-1 and sale gain, records, failure points, and pre-closing decisions. It replaces unrelated real-estate-professional FAQs with four sale-specific questions and matching FAQPage JSON-LD, and has standalone exact `/discovery/` booking CTAs near the answer and after the analysis. This existing-URL improvement does not advance the separate 200-new-URL count.
- Primary sources: [IRS partner K-1 instructions](https://www.irs.gov/instructions/i1065sk1), [Publication 541](https://www.irs.gov/publications/p541), [Publication 925](https://www.irs.gov/publications/p925), and [IRS Section 704(d) FAQ](https://www.irs.gov/newsroom/new-limits-on-partners-shares-of-partnership-losses-frequently-asked-questions). Competitor pages informed only query coverage, not tax authority.
- Premium-buyer decision: A partner selling an interest in a debt-financed real-estate venture faces a consequential exit-year deduction, gain, and K-1 reconciliation. The outside-basis, at-risk, passive-loss, debt, and Section 751 questions require an owner-level model that fits AE's partnership return and sale-year review work; this is not a generic loss definition.
- Status: Commit `a7d06ba9` was pushed to main. Rechecked September 24: 1,301 canonical indexable URLs equal 1,301 sitemap URLs; content quality scanned 1,988 HTML files with zero errors/warnings, broken internal links 0, date conflicts 0, invalid JSON-LD 0, scaled-content errors/warnings 0, and `git diff --check` clean. The broader validator retains only unrelated legacy/staging notices. The live canonical returned HTTP 200 with the revised H1, self-canonical, IRS partner K-1/Publication 541/925 citations, a worked loss-bucket example, two standalone exact booking CTAs, and September 24 sitemap lastmod. IndexNow accepted the changed canonical, HTTP 200 (1/1). Authenticated Search Console says the established URL is indexed; its fresh September 24 live test says the revision is available to Google, can be indexed, and has valid breadcrumb and review-snippet items. The owner-approved current sitemap resubmission succeeded with Success and 1,301 discovered pages. The property's manual recrawl quota is exhausted for the day; under the documented quota-limited fallback, the live sitemap, internal links, and successful IndexNow submission complete the indexing submission gate. Count **70/100**; the separate new-URL count remains **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 75: Form 3115 on an amended return

- Query: “Can I file Form 3115 with an amended return?”
- Score: buyer and consultation intent **27/30** (the return is already filed and the owner must choose a procedurally valid correction before a short relief window closes); distinctness/canonical fit **25/25** (the established amendment-versus-Form-3115 canonical owns this answer; a second URL would cannibalize it); evidence **16/20** (authenticated Search Console recorded two impressions for this exact wording in its September 18–22 window; the supplied September 23 query export and organic-position CSV do not show the exact question, while current results show practitioner discussion and IRS procedure addressing it); AE paid-service fit **15/15** (method-change, entity return, K-1 and amendment review); authority/competitive gap **9/10** (the old AE guide did not answer the amendment timing question and omitted the conditional six-month and disposed-property paths). **Total: 92/100.** Do not infer volume from the two impressions.
- Decision: Materially improve [the established canonical](https://www.aetaxadvisors.com/amended-return-vs-form-3115/), not publish a synonym. The updated guide distinguishes ordinary automatic and nonautomatic Form 3115 filing, Revenue Procedure 2015-13's six-month amended-return relief conditions, the change-specific disposed-property amended-return/AAR exception, a later eligible year of change, and a factual-error amendment without Form 3115. It adds a worked S-corporation study timing example, records and failure points, cross-links to the separate sale-year and late-study guides, primary sources, and two standalone exact booking CTAs. This is an existing-URL improvement, so the separate 200-new-URL count does not increase.
- Primary sources: [Form 3115 instructions](https://www.irs.gov/instructions/i3115), [Revenue Procedure 2015-13 §6.03(4)(a)](https://www.irs.gov/pub/irs-drop/rp-15-13.pdf), and [Revenue Procedure 2025-23 §6.07](https://www.irs.gov/irb/2025-24_IRB#REV-PROC-2025-23). Competitor discussions supplied only query and coverage evidence.
- Validation and publication: current sitewide gates pass with 1,301 canonical indexable URLs equal 1,301 sitemap URLs; content quality scanned 1,988 HTML files with zero errors/warnings, broken internal links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0 for zero new pages. The full validator retains only unchanged unrelated legacy/staging notices. The four visible FAQ answers match FAQPage JSON-LD, the title is 55 characters, the description 149 characters, and two exact booking CTAs stand alone. Commit `8d27f557` was pushed to main. Rechecked September 24, the [live canonical](https://www.aetaxadvisors.com/amended-return-vs-form-3115/) returned HTTP 200 with the revised H1, self-canonical, direct booking CTA in the HTML, six-month exception analysis, and a live sitemap entry. IndexNow accepted the changed canonical, HTTP 200 (1/1). Authenticated Search Console says the established URL is indexed; its September 24 post-deployment live test says the revision is available to Google, can be indexed, and has one valid breadcrumb. The owner-approved current sitemap resubmission later succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day, so the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. The exact-query impression and consequential entity-return correction make this a premium-owner fit. Count **75/100**; separate new-URL count **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 78 and additional new URL 8: rental 1031 into a vacation home

- Query: “I'm selling a rental. Can I 1031 exchange into a vacation home I will also use?”
- Score: buyer and consultation intent **29/30** (an owner choosing a replacement before relinquished-property closing faces irreversible intermediary, acquisition-intent, and use decisions); distinctness **25/25** (AE's common-mistakes page mentions vacation homes briefly, but no established canonical owns the replacement-dwelling day-count and later-conversion question); evidence **18/20** (authenticated September 18–22 Search Console shows two impressions each for “1031 exchange rental property for vacation home,” “1031 exchange for vacation rental,” and “1031 exchange vacation rental”; the supplied organic-position CSV and September 23 Search Console query export have no exact vacation-exchange row; current Google results show exact-intent coverage from 1031 Corp, LegalClarity, and qualified-intermediary sites; the full natural-language question is an editorial synthesis); AE paid-service fit **14/15** (pre-closing exchange and return review); authority/competitive gap **9/10** (a primary IRS safe harbor is available but AE's current coverage lacks per-year day counts, failure examples, and amendment consequences). **Total: 95/100.**
- Decision: Publish one genuinely distinct [vacation-home replacement decision guide](https://www.aetaxadvisors.com/blog/1031-exchange-rental-into-vacation-home/), not a generic 1031 or property-type swap. The new page answers whether mixed personal/rental use can qualify; distinguishes investment intent from later personal plans, tests each of the two 12-month periods with a failing worked example, separates the relinquished-property test from the replacement-property test and from 45/180-day exchange mechanics, explains the safe harbor's limited scope, and flags later Section 121 and amended-return issues. It includes a pre-closing document packet, failure points, current IRS sources, internal links and two standalone exact `/discovery/` booking CTAs. If live publication and indexing gates pass, it would add one accepted target and one new URL to the separate 200-page ledger.
- Primary sources: [IRS Revenue Procedure 2008-16](https://www.irs.gov/pub/irs-drop/rp-08-16.pdf), [Form 8824 instructions](https://www.irs.gov/instructions/i8824), [IRS Publication 527](https://www.irs.gov/publications/p527), and [IRS Publication 523](https://www.irs.gov/publications/p523). Competitor pages informed query/coverage research only.
- Status: Commit `1483425a` was pushed to main. At publication the full gates passed, including zero scaled-content errors/warnings for this one new page. Current sitewide gates pass with 1,301 canonical indexable pages matching 1,301 sitemap URLs; content-quality errors/warnings 0 across 1,988 HTML files, broken internal links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0. Rechecked September 24, the [live page](https://www.aetaxadvisors.com/blog/1031-exchange-rental-into-vacation-home/) returns HTTP 200 with the question-led H1, self-canonical, Revenue Procedure 2008-16 and 14-day analysis, direct booking CTAs, and a live sitemap entry. The blog card and common-mistakes inbound link were verified at publication. IndexNow accepted the new guide and both changed supporting canonicals, HTTP 200 (3/3). Authenticated Search Console reports “URL is unknown to Google” in its stored index; its September 24 live test reports “URL is available to Google,” “Page can be indexed,” and one valid breadcrumb. The owner-approved current sitemap resubmission later succeeded with Success and 1,301 discovered pages. Google's manual indexing-request quota is exhausted for the day; under the documented quota-limited fallback, live sitemap discovery, internal links, and successful IndexNow submission complete the submission gate, but **not** actual Google indexation. The pre-closing replacement-property decision and documented exchange rules give this a premium-owner, distinct-tax-treatment fit rather than a property-type swap. Count **78/100** and **8/200** additional new URLs. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 79: moving into a former rental

- Query: “I'm moving into my rental property. What happens to depreciation and tax when I sell?”
- Score: buyer and consultation intent **28/30** (the owner needs a conversion-date and pre-sale return review); distinctness/canonical fit **24/25** (the existing former-rental URL owns this direction of conversion, unlike AE's home-to-rental guide); evidence **17/20** (the supplied organic-position export reports 40 monthly searches for “convert rental property to personal residence” at positions 43 and 56 and 40 for the close “converting rental property to personal residence” at position 52, all incorrectly associated with AE's opposite-direction URL; authenticated Search Console showed one impression for “rental property converted to personal use” in September 18–22; current results include IRS Publication 523's exact rental-to-main-home example and the Tax Adviser and Nolo treatments; the full question wording is an editorial synthesis); paid-service fit **14/15** (depreciation, suspended-loss and sale-return review); authority/competitive gap **9/10** (the old canonical was a short generic answer that omitted Section 121 nonqualified use and suspended-loss treatment). **Total: 92/100.**
- Decision: Materially improve [the existing former-rental canonical](https://www.aetaxadvisors.com/blog/rental-property-converted-to-personal-use/) and cross-link it from AE's opposite-direction conversion guide, rather than create a synonym page. The revision distinguishes temporary vacancy from permanent personal conversion, reconciles the part-year Schedule E and asset schedules, retains allowed-or-allowable depreciation and suspended losses, and tests Section 121's two-year use, nonqualified-use and depreciation limitations with a worked sale example. It adds a document packet, failure points, current IRS sources, and standalone exact `/discovery/` booking CTAs near the top and after the analysis. No new URL counts toward the 200-page milestone.
- Primary sources: [IRS Publication 527](https://www.irs.gov/publications/p527), [IRS Publication 523](https://www.irs.gov/publications/p523), [IRS Publication 925](https://www.irs.gov/publications/p925), [IRS Publication 946](https://www.irs.gov/publications/p946), and [Schedule E instructions](https://www.irs.gov/instructions/i1040se). Competitor results informed only query/coverage research.
- Status: Current sitewide editorial and technical validation passed: 1,301 canonical indexable URLs equal 1,301 sitemap URLs; content-quality errors/warnings 0 across 1,988 HTML files, broken links 0, date conflicts 0, invalid JSON-LD 0, scaled-content errors/warnings 0; `git diff --check` clean. Commits `8209db63` (guide, cross-link, ledger) and `e816bbfe` (sitemap date) were pushed to main. Rechecked September 24, the [live guide](https://www.aetaxadvisors.com/blog/rental-property-converted-to-personal-use/) returned HTTP 200 with its new title/H1, self-canonical, two standalone exact booking CTAs, Section 121/nonqualified-use analysis, IRS citations, and a live sitemap entry; the opposite-direction guide's inbound link was verified at publication. IndexNow accepted both changed canonical URLs, HTTP 200 (2/2). Authenticated Search Console says the established URL is indexed; its September 24 post-deployment live test says “URL is available to Google,” “Page can be indexed,” and detects one valid breadcrumb item. The owner-approved current sitemap resubmission later succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day; the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. The conversion and later-sale question has premium-owner fit because it affects accumulated depreciation, suspended losses, and home-sale gain on an investment asset, not a generic homeowner query. Count **79/100**; separate new-URL count **8/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 76: IRA-owned real estate syndication

- Query: “I'm considering a leveraged real estate syndication through my self-directed IRA. Will its K-1 create UDFI tax or a Form 990-T filing, and would a solo 401(k) change that?”
- Score: buyer and consultation intent **29/30** (the investor must choose an account before subscription or reconcile an existing IRA K-1); distinctness/canonical fit **25/25** (AE's established self-directed-IRA/UDFI URL owns the account-level issue, while its LP guide addresses personally held investments); query evidence **17/20** (authenticated Search Console showed two impressions for “i'm considering investing through a self-directed ira. what should i know about using it for real estate syndications?” plus one each for two solo-401(k)-syndication questions in its September 18–22 window; the supplied organic-position export has no exact IRA-syndication row, and the full combined wording is editorial synthesis; current results include Directed IRA and other exact-intent comparisons); AE paid-service fit **14/15** (K-1/Form 990-T review and retirement-plan tax structuring, subject to engagement scope); authority/competitive gap **9/10** (the old canonical made categorical and sometimes misleading claims about all unleveraged income, solo-plan exemptions, personally funded expenses, and debt payoff before a sale). **Total: 94/100.**
- Decision: Materially improve [the established IRA real-estate canonical](https://www.aetaxadvisors.com/blog/self-directed-ira-real-estate-ubit-udfi/) instead of publishing a syndication synonym. The revised page directly answers the buyer question; separates the account from the individual return; tests UDFI/other UBTI, the $1,000 gross-income filing threshold, box 20 code V/AR, Section 514(c)(9)'s partnership-level conditions, sale-year debt history, and prohibited transactions; gives a two-year K-1-versus-UDFI example, decision sequence, document packet, and failure points. Direct `/discovery/` booking CTAs stand alone near the answer and after the substantive content, with no inline button or calendar interruption. The taxable LP guide and blog index link to the canonical. No new URL counts toward the separate 200-page milestone.
- Primary sources: [IRS Form 990-T instructions](https://www.irs.gov/instructions/i990t), [partner K-1 instructions](https://www.irs.gov/instructions/i1065sk1), [Publication 598](https://www.irs.gov/publications/p598), [IRS IRA FAQs](https://www.irs.gov/retirement-plans/retirement-plans-faqs-regarding-iras), [one-participant 401(k) guidance](https://www.irs.gov/retirement-plans/one-participant-401k-plans), and [prohibited-transaction guidance](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-topics-prohibited-transactions). Competitor pages were used only for query-pattern and coverage research, not tax authority.
- Validation and publication: current sitewide gates pass with 1,301 canonical indexable URLs matching 1,301 sitemap URLs; content quality scanned 1,988 HTML files with zero errors/warnings, broken internal targets 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0 for zero new URLs. The five visible FAQ answers match their FAQPage JSON-LD. `seo_validate.py` retains unchanged legacy/staging notices outside the affected pages. Commit `4b47362f` was pushed to main. Rechecked September 24, the [live canonical](https://www.aetaxadvisors.com/blog/self-directed-ira-real-estate-ubit-udfi/) returns HTTP 200, self-canonical, direct booking CTAs, Form 990-T and solo-plan analysis, and a live sitemap entry; the taxable LP guide's inbound link was verified at publication. IndexNow accepted all three changed canonical URLs (IRA guide, LP guide, blog index), HTTP 200, 3/3. Authenticated Search Console says the established URL is indexed; the post-deployment live test says “URL is available to Google,” “Page can be indexed,” and reports valid breadcrumb and review-snippet items. The owner-approved current sitemap resubmission later succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day, so the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. This is a premium real-estate investor decision involving leveraged syndication capital, entity K-1 data, and account-level tax exposure; it is not a generic retirement-account definition. Count **76/100**; separate new-URL count **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 71: Section 704(c) without depreciable assets

- Query: “Our partnership has no intangibles or depreciable assets. Do we still need a Section 704(c) allocation on Form 1065?”
- Score: buyer and consultation intent **27/30** (partners must decide how to prepare a filed or imminent 1065/K-1); distinctness/canonical fit **25/25** (AE's established Section 704(c) guide owns contributed-property allocation, and a second land-only URL would cannibalize it); query evidence **18/20** (the supplied organic-position export reports position 17 and a 1,300/month estimate for the awkwardly phrased close query “can you allocate 704c with no intangibles or depreciable assets”; authenticated Search Console showed 354 September 18–22 impressions for the broader 704 query family at average position 6.3, not for this exact full question; current results include nondepreciable-land allocation examples and competing partnership-tax explanations); AE paid-service fit **15/15** (partnership return, K-1, and correction review); authority/competitive gap **10/10** (the old AE page misstated a deemed sale, method default, distribution timing, tiered example, and partner allocation, and had off-topic FAQs). **Total: 95/100.** The natural buyer phrasing above is an editorial synthesis, not a claim that the exact sentence has measured demand.
- Decision: Materially improve the established [Section 704(c) canonical](https://www.aetaxadvisors.com/the-business-owners-guide-to-section-704c-built-in-gains-and-loss-allocations/), not create a synonym page. The revision answers cash versus land versus reverse book-up directly, adds a property-level decision sequence, an internally consistent $5 million land/$2 million basis example with 50/25/25 ownership, source-backed Form 1065/K-1 item M/N/box 20 code AA guidance, records and correction route, and two standalone `/discovery/` “Book a Return Review Call” CTAs. It preserves the original topic coverage while replacing materially inaccurate sentences and off-topic FAQ/schema with matching Section 704(c) questions. No new indexable URL counts toward the separate 200-page milestone.
- Primary sources: [Treasury Regulation §1.704-3](https://www.ecfr.gov/current/title-26/section-1.704-3), [IRS Publication 541](https://www.irs.gov/publications/p541), [Form 1065 instructions](https://www.irs.gov/instructions/i1065), and [partner K-1 instructions](https://www.irs.gov/instructions/i1065sk1). The current statute and IRS instructions use seven years for Section 704(c)(1)(B), while some older regulation text still states the former five-year period; the page flags that conflict. Competitor results are query-pattern evidence only.
- Validation: content quality 0 errors/0 warnings with 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. Four visible FAQs exactly match FAQPage schema; title is 59 characters, meta description 146 characters, Article modification date September 24, and two direct booking CTAs passed focused checks. The full validator's unrelated legacy/staging notices remain unchanged.
- Premium-buyer decision: The likely reader is a partner or CFO preparing Form 1065 and investor K-1s after a valuable land contribution or partnership book-up. The built-in-gain allocation can shift material tax between owners; property-level method selection, documentation, and return review are plausible AE paid engagements.
- Publication/indexing: commit a523d8d4 was pushed to main. Rechecked September 24: the [live canonical](https://www.aetaxadvisors.com/the-business-owners-guide-to-section-704c-built-in-gains-and-loss-allocations/) returned HTTP 200 with the land-versus-cash answer, self-canonical, current regulation/IRS sources, matching on-topic FAQ, and two standalone direct booking CTAs; its September 24 lastmod is live in [sitemap.xml](https://www.aetaxadvisors.com/sitemap.xml). Current sitewide gates pass at 1,301 canonical indexable URLs = 1,301 sitemap URLs, 1,988 HTML files CTA-scanned, content-quality errors/warnings 0, broken links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0. IndexNow accepted the changed canonical, HTTP 200 (1/1). Authenticated Search Console says this established URL is indexed; its fresh September 24 live test says the revision is available to Google, can be indexed, and has one valid breadcrumb plus one valid review-snippet item. The owner-approved sitemap resubmission succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day, so the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. Count **71/100**; separate new-URL count **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Pending Search Console submission gate: rental vacant during a six-month renovation

- Query: “My rental sat empty for six months during a renovation. Can I deduct interest, taxes, repairs, and depreciation on this year's return?”
- Score: buyer and consultation intent **27/30** (the owner is classifying substantial costs before filing); distinctness/canonical fit **24/25** (the existing vacancy-expense URL is the right answer, distinct from AE's first placed-in-service and renovation-disposition guides); query evidence **12/20** (the supplied organic-position export has no exact vacancy question and authenticated Search Console has zero “vacant” impressions in its short September 18–22 window; current Google results include close renovation-vacancy deduction questions and competing tax guides, so this is a plausible specific buyer question rather than measured AE demand); AE paid-service fit **15/15** (Schedule E, improvement-basis, depreciation, and loss-limit review); authority/competitive gap **8/10** (the existing page had a seven-week turnover example but not the longer renovation and prior-use decision). **Total: 86/100.**
- Decision: Materially improve the established [vacant-rental canonical](https://www.aetaxadvisors.com/blog/rental-property-vacancy-expenses/), not create another URL. The revised page answers the six-month renovation question directly, distinguishes an established temporarily idle rental from a never-ready first rental and a property removed from rental use, uses a five-row cost classification table and a six-month worked example, separates capital improvements from ordinary holding costs, explains why a Schedule E loss may be suspended, gives documents to gather and pre-filing decisions, and links to the proper placed-in-service, passive-loss, and accounting-method canonicals. It retains the original turnover, recordkeeping, error, source, and related-reading topics while giving two standalone `/discovery/` “Book a Return Review Call” CTAs. No new URL counts toward the separate 200-page milestone.
- Primary sources: [IRS Publication 527](https://www.irs.gov/publications/p527), [IRS Publication 946](https://www.irs.gov/publications/p946), and [IRS Publication 925](https://www.irs.gov/publications/p925). Competitor pages are demand-pattern evidence, not tax authority.
- Validation: content quality 0 errors/0 warnings with 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. The full validator's unrelated legacy/staging notices remain unchanged.
- Publication/indexing: commit 0b0f8296 was pushed to main. The [live canonical](https://www.aetaxadvisors.com/blog/rental-property-vacancy-expenses/) returned HTTP 200 with the new renovation decision guide, self-canonical, and two standalone direct booking CTAs; its September 24 lastmod is live in [sitemap.xml](https://www.aetaxadvisors.com/sitemap.xml). IndexNow accepted the changed canonical, HTTP 200 (1/1). Authenticated Search Console says the established URL is indexed; its September 24 post-deployment live test says the revision is available to Google, can be indexed, and has one valid breadcrumb item. Manual recrawl and current sitemap resubmission await specific action-time approval. Do not increment the 67 accepted-target count before that final gate is resolved. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 74: cost segregation with a planned sale in two years

- Query: “I may sell my rental in two years. Is a cost segregation study still worth paying for?”
- Score: buyer and consultation intent **28/30** (the owner is deciding whether to commission a paid study before a near-term exit); distinctness/canonical fit **24/25** (the established /cost-segregation-before-selling-property/ page owns the investment decision, while AE's depreciation-on-sale guides own reporting after a completed study); query evidence **13/20** (authenticated Search Console showed 1.61K September 18–22 impressions for cost-segregation-containing queries, but none of its 37 sale-containing queries mentioned this study; the supplied organic-position export has broad cost-segregation and calculator rankings but no exact short-hold question. Current Google results and real investor discussions ask whether a 1–3-year hold defeats study value, so this is a credible buyer question, not claimed exact-volume demand); AE paid-service fit **15/15** (study scoping, return implementation, sale-year tax modeling); authority/competitive gap **8/10** (the existing AE page mentioned recapture but did not compare usable early deductions, asset-level sale allocations, fees, and short-hold scenarios). **Total: 88/100.**
- Decision: Materially improve the established [pre-sale cost-segregation canonical](https://www.aetaxadvisors.com/cost-segregation-before-selling-property/), not create a second short-hold URL. The revision directly answers the two-year question, replaces generic takeaways, and compares an illustrative $50,000 accelerated deduction, $6,000 fee, and two different recapture outcomes without promising a return. It explains Section 1245 asset-level limits, Section 1250 character, passive-loss release conditions, 1031 caveats, Form 3115 timing, document requests, failure points, and related AE guides. A new visible/schema FAQ matches exactly, and direct standalone /discovery/ “Book a Return Review Call” CTAs sit near the top and after the analysis. No new indexable URL counts toward the separate 200-page milestone.
- Primary sources: [IRS Cost Segregation Audit Techniques Guide](https://www.irs.gov/pub/irs-pdf/p5653.pdf), [IRS Publication 544](https://www.irs.gov/publications/p544), [IRS Publication 925](https://www.irs.gov/publications/p925), [Form 4797 instructions](https://www.irs.gov/instructions/i4797), and [Form 3115 instructions](https://www.irs.gov/instructions/i3115). Competitor pages are question-pattern evidence, not authority for tax outcomes.
- Validation: content quality 0 errors/0 warnings with 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. Four visible FAQ questions match the FAQ schema; the Article modification date, 148-character description, and two direct booking CTAs passed focused checks. The full validator's unrelated legacy/staging notices are unchanged.
- Publication/indexing: commit cffe84fd was pushed to main. Rechecked September 24: the [live canonical](https://www.aetaxadvisors.com/cost-segregation-before-selling-property/) returned HTTP 200 with the 18-month hold comparison, self-canonical, two standalone direct booking links, and a live sitemap entry. Current sitewide gates pass at 1,301 canonical indexable URLs = 1,301 sitemap URLs, 1,988 HTML files CTA-scanned, content-quality errors/warnings 0, broken links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0; the broader validator retains only unrelated legacy/staging notices. IndexNow accepted the changed canonical, HTTP 200 (1/1). Authenticated Search Console says the established URL is indexed; its September 24 post-deployment live test says the revised page is available to Google, can be indexed, and has one valid breadcrumb item. The owner-approved current sitemap resubmission succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day, so the documented quota-limited fallback uses the live sitemap, contextual internal links, and successful IndexNow submission. The paid-study-versus-sale decision has premium-owner fit because it entails a meaningful property basis, study fee, deduction usability, and sale-year tax exposure. Count **74/100**; separate new-URL count **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 73: identified 1031 replacement falls through after Day 45

- Query: “My identified 1031 replacement fell through after Day 45. Can I buy a different property?”
- Score: buyer and consultation intent **27/30** (a sold-property owner faces an immediate backup-closing and tax-exposure decision); distinctness/canonical fit **24/25** (the established 45/180-day timeline URL owns identification, while this failed-contract decision is different from the already-covered clock-start question); query evidence **14/20** (authenticated Search Console showed 363 September 18–22 impressions for 1031-containing queries, including 49 for “1031 exchange timeline,” but no measured exact failed-contract phrase; its sole “identif” query was a quiz question, not a buyer. The supplied organic-position export reports “1031 exchange 45 day rule extension” at position 23 with a 40/month volume signal; current results include exact after-Day-45 replacement questions and competitor guides. This is a credible buyer-intent synthesis, not claimed exact-query demand); AE paid-service fit **15/15** (exchange tax coordination, QI-document review, failed-exchange return modeling); authority/competitive gap **8/10** (the existing guide mentioned a locked list but lacked a failed-deal decision path). **Total: 88/100.**
- Decision: Materially improve the existing [1031 timeline canonical](https://www.aetaxadvisors.com/blog/1031-exchange-timeline-45-180-day-rules/), not publish a duplicate URL. The new answer distinguishes signed timely identifications from drafts, revocation before Day 45 from attempted substitution afterward, a valid backup from an unlisted property, and the three-property/200%/95% tests. It gives a three-building Day-60 financing-failure example, document packet, QI/return decision sequence, primary sources, related alternative and tax-coordination links, a matching visible/JSON-LD FAQ, and standalone /discovery/ booking CTAs already present near the answer and after the guide. The blog index and tax-rule hub now describe the failed-deal decision. The related planning-service page links back and corrects a contradictory Day-42 failed-exchange claim plus nearby unconditional deferral, DST, and boot language; those sentence-level corrections are not a second counted target. This is a distinct question on an existing URL; the separate 200-new-URL count does not change.
- Primary sources: [Treasury Regulation 1.1031(k)-1](https://www.ecfr.gov/current/title-26/section-1.1031(k)-1) (identification, revocation, multiple-property and receipt rules) and [IRS Form 8824 instructions](https://www.irs.gov/instructions/i8824) (45-day, earlier-of-180-day/return-due-date, and written-identification requirements). Competitor question patterns are demand evidence only, not tax authority.
- Validation: content quality 0 errors/0 warnings with 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. All seven visible FAQ questions match the FAQ schema, and the canonical plus two direct booking CTAs are present. The full validator's unrelated legacy/staging notices are unchanged.
- Publication/indexing: commit 92730889 pushed to main. Rechecked September 24: sitewide content quality passed with 1,301/1,301 canonical/sitemap parity and zero errors/warnings across 1,988 HTML files; broken internal links 0, date conflicts 0, invalid JSON-LD 0, scaled-content errors/warnings 0, and `git diff --check` clean. The [live 1031 timeline canonical](https://www.aetaxadvisors.com/blog/1031-exchange-timeline-45-180-day-rules/) returned HTTP 200 with the failed-contract section, self-canonical, matching FAQ, and two direct standalone booking buttons. The [supporting planning page](https://www.aetaxadvisors.com/1031-exchange-planning/), blog card, tax-rule hub, and both affected sitemap entries were verified live. IndexNow accepted all four changed canonical URLs, HTTP 200 (4/4). Authenticated Search Console says the established timeline URL is indexed; its fresh September 24 live test says the revision is available to Google, can be indexed, and has one valid breadcrumb plus one valid review-snippet item. The owner-approved current sitemap resubmission succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day; the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. This decision has premium-owner fit because a sold-property owner faces a consequential replacement closing and tax exposure, not a generic 1031 definition query. Count **73/100**; separate new-URL count **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Accepted target 72: fixed partner payment filed as a distribution

- Query: “We reported a fixed partner payment as a distribution. Do we need to correct Form 1065 and the K-1?”
- Score: buyer and consultation intent **28/30** (the partnership and partners have already filed inconsistent returns and face an entity-level correction decision); distinctness/canonical fit **24/25** (the existing `/blog/business-partnership-guaranteed-payment/` owns payment classification, while `/partnership-aar-vs-amended-return/` owns the general BBA procedure); query evidence **15/20** (authenticated Search Console showed two September 18–22 impressions for close “707(c) guaranteed payments” queries, but not the full buyer wording; the supplied organic-position export had no exact guaranteed-payment row; current results include filed-1065 and distribution-versus-payment questions, so the long question is an editorial synthesis); AE paid-service fit **15/15** (Form 1065, corrected partner reporting, amendment/AAR review); authority/competitive gap **8/10** (AE's existing page defined guaranteed payments but did not guide a filed-return correction). **Total: 90/100.**
- Decision: Materially improve the established canonical, not create a synonym URL. The revised guide separates fixed service payments from profit shares, cash distributions, nonpartner-capacity transactions, and capitalizable costs; traces the entity deduction, recipient and other partners' K-1s, basis and later-year records; illustrates two 50/50 partners and a $60,000 manager payment; and directs the BBA amendment/AAR decision to the established procedure guide. It adds records, failure points, current IRS primary sources, and direct standalone `/discovery/` “Book a Return Review Call” links near the answer and end. The AAR guide, blog index, and business-question hub link back. No new URL counts toward the separate 200-page milestone.
- Primary sources: [IRS Publication 541](https://www.irs.gov/publications/p541), [Form 1065 instructions](https://www.irs.gov/instructions/i1065), and [Form 1065-X instructions](https://www.irs.gov/instructions/i1065x). Current search discussions are query-pattern evidence only, not authority for the tax treatment.
- Validation: content quality 0 errors/0 warnings with 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. Unrelated legacy/staging full-validator notices are unchanged.
- Premium-buyer decision: The likely reader is an owner or partnership representative correcting a material fixed manager payment after Form 1065 and multiple K-1s were filed. Entity deductions, partner income, capital/basis schedules, and the BBA correction path create a genuine AE return-review engagement, not a general definition query.
- Publication/indexing: commit `3280fd34` pushed to `main`; rechecked September 24, the [live improved canonical](https://www.aetaxadvisors.com/blog/business-partnership-guaranteed-payment/) returned HTTP 200 with the revised H1, self-canonical, $60,000 worked example, current IRS Publication 541/Form 1065/1065-X sources, two standalone `/discovery/` booking buttons, and a September 24 sitemap `lastmod`. The blog card, business-question hub, and related AAR guide link back. Current sitewide gates pass: 1,301 canonical indexable pages equal 1,301 sitemap URLs; content-quality errors/warnings 0 across 1,988 HTML files; broken links 0; date conflicts 0; invalid JSON-LD 0; scaled-content errors/warnings 0. IndexNow accepted all four changed canonical URLs, HTTP 200 (4/4). Authenticated Search Console reports the established URL is indexed; its fresh September 24 live test says the revision is available to Google, can be indexed, and has one valid breadcrumb item. The owner-approved sitemap resubmission succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day, so the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. Count **72/100**; separate new-URL count **6/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Pending Search Console submission gate: remaining rental mortgage points

- Query: “I sold or refinanced my rental before deducting all its mortgage points. Can I deduct the rest now?”
- Score: buyer and consultation intent **26/30** (an owner is about to close or file a payoff-year return with an unrecovered loan cost); distinctness/canonical fit **23/25** (the existing `/blog/rental-property-mortgage-points/` is the proper mortgage-point canonical, while the cash-out guide owns tracing of refinance proceeds); query evidence **10/20** (the supplied organic-position export has no exact points term and authenticated Search Console shows zero “mortgage points” impressions for September 18–22; current results include payoff/refinance questions and a tax-professional discussion of the same-lender exception, so the full question is credible synthesis, not measured demand); AE paid-service fit **15/15** (rental return, loan-cost, and pre-sale review); authority/competitive gap **8/10** (the existing points page omitted payoff, OID method, lender continuity, and cash-out allocation). **Total: 82/100.**
- Decision: Materially improve the existing canonical, not add a points synonym. The revised answer distinguishes interest-like points from other closing charges, de minimis versus constant-yield OID recovery, sale/payoff versus same- and different-lender refinancing, and personal-use cash-out allocation. It includes a $400,000 loan/$4,000 points/$2,800 remaining example, document packet, failure points, relevant AE internal links, and standalone problem-specific `/discovery/` booking buttons near the answer and end. A sentence-level correction on the cash-out refinance guide removes its unconditional $320/year straight-line claim and links back; that supporting correction is not a second counted target. The separate 200-new-URL count does not change.
- Primary authority: [IRS Publication 527, Points and Loan or mortgage ends](https://www.irs.gov/publications/p527). Competitor and search-result material supports query language only; tax conclusions come from the IRS.
- Validation: content quality 0 errors/0 warnings with 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. Legacy/staging full-validator notices are unrelated and unchanged.
- Publication/indexing: commit `cb3047db` pushed to `main`; the [live improved canonical](https://www.aetaxadvisors.com/blog/rental-property-mortgage-points/) returned its revised H1, self-canonical, both standalone booking CTAs, and September 24 sitemap lastmod. The supporting cash-out correction, blog card, and rental-question guide were verified live. IndexNow accepted all four changed canonical URLs, 4/4, HTTP 200. Authenticated Search Console says the established URL is indexed, and its post-deployment live test says the revised page is available to Google, can be indexed, and has one valid breadcrumb. A manual recrawl and current sitemap resubmission await action-time approval. Hold the 67 accepted-target count until that final gate is resolved.

### September 24, 2026 — Pending Search Console submission gate: wrong rental depreciation start date

- Query: “I used the wrong start date for rental depreciation. Do I need to amend?”
- Score: buyer and consultation intent **27/30** (the owner has already filed and needs a correction before more returns or a sale); distinctness/canonical fit **23/25** (the established `/blog/rental-property-placed-in-service-date/` owns the start-date determination, so a material expansion avoids a competing URL); query evidence **13/20** (the supplied organic-position export shows broader rental-depreciation calculation demand, including 50 monthly searches at position 27 for “calculate rental property depreciation,” but no exact date-correction query; current results include ready-and-available timing and past-return correction questions, so the full wording is a credible synthesis, not a measured query); AE paid-service fit **15/15** (rental depreciation and amended-return review); authority/competitive gap **9/10** (the established page had no answer to the already-filed correction decision). **Total: 87/100.**
- Decision: Materially improve the existing canonical, not add a date-variant page. The draft now directly distinguishes closing, readiness, and first occupancy; separates initial renovation from temporary vacancy and separately placed improvements; walks through date proof, a return/schedule correction, a $275,000-building July-versus-September example, downstream basis, records, and errors. It explains from current IRS publications that a date-only change is not a Form 3115 method change, while reserving entity, closed-year, and separate-method issues for review. Exact standalone `/discovery/` booking buttons are near the answer and after the content. The blog index and rental-question hub point to the revised intent. No new URL counts toward the separate 200-page milestone.
- Primary sources: [IRS Publication 527](https://www.irs.gov/publications/p527), [IRS Publication 946](https://www.irs.gov/publications/p946), [Form 3115 instructions](https://www.irs.gov/instructions/i3115), and [IRS amended-return guidance](https://www.irs.gov/filing/file-an-amended-return). Current non-IRS results are query-pattern evidence only, not tax authority.
- Validation: content quality 0 errors/0 warnings and 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. The full validator still reports unrelated legacy/staging metadata notices.
- Publication/indexing: commit `42677091` pushed to `main`; the [live improved canonical](https://www.aetaxadvisors.com/blog/rental-property-placed-in-service-date/) returned the revised H1, self-canonical, both standalone booking links, and September 24 sitemap lastmod. The live blog card and rental-question hub link to it. IndexNow accepted the article, blog hub, and rental-question hub, 3/3, HTTP 200. Authenticated Search Console reports the established URL is indexed; the post-deployment live test says the revised page is available to Google, can be indexed, and has one valid breadcrumb. Its sitemap report is Success but still shows 1,296 discovered pages, a count from before later pushes. Manual recrawl and confirmatory sitemap resubmission await action-time approval. Do not increment the 67 accepted-target count until this final gate is resolved.

### September 24, 2026 — Accepted target 80: seller credit on a rental purchase

- Query: “The seller gave me a repair credit and paid some closing costs on my rental purchase. Which amount reduces depreciable basis?”
- Score: buyer/consultation intent **27/30** (a buyer is preparing the first rental depreciation schedule or cost-segregation engagement); distinctness/canonical fit **22/25** (the established `/blog/rental-purchase-seller-credits-basis/` URL already owns this intent, so improving it avoids a duplicate); query evidence **11/20** (the September 18–22 authenticated Search Console query filter for “seller credit” showed zero impressions and the supplied organic-position export had no exact term, but current search results include a cost-segregation competitor's seller-credit/closing-cost guide and buyer questions about credits affecting basis; the full question is a plausible buyer-intent synthesis, not a measured query); AE service fit **15/15** (rental acquisition-basis and return review); authority/competitive gap **8/10** (the existing page lacked a complete closing reconciliation and near-answer consultation path). **Total: 83/100.**
- Decision: Materially improve the existing canonical, not create a synonym URL. The revised title/H1 and lead answer the basis question directly; the page now distinguishes an actual price cut from a seller-funded loan charge, gives two $500,000 duplex scenarios, a five-line contract-to-Form-4562 reconciliation, records, failure points, a link to the buyer-side cost-segregation guide, and direct standalone `/discovery/` booking CTAs near the answer and at the end. It avoids claiming that every seller-funded cost automatically reduces building basis. No new URL is counted toward the separate 200-page milestone.
- Primary sources: [IRS Publication 551, Basis of Assets](https://www.irs.gov/publications/p551), [IRS Publication 527, Residential Rental Property](https://www.irs.gov/publications/p527), and [IRS rental-expenses FAQ](https://www.irs.gov/faqs/sale-or-trade-of-business-depreciation-rentals/rental-expenses/rental-expenses). Current competitor results were used for query-pattern and coverage evidence only, not tax conclusions.
- Validation: content quality 0 errors/0 warnings and 1,299/1,299 canonical/sitemap parity; broken internal links 0; date conflicts 0; invalid JSON-LD 0; scaled-content guard 0 errors/0 warnings for zero new indexable pages. The full validator's unrelated legacy/staging metadata and duplicate-title notices remain unchanged.
- Publication: commit `992e8621` pushed to `main`. Rechecked September 24, the [live improved canonical](https://www.aetaxadvisors.com/blog/rental-purchase-seller-credits-basis/) returned HTTP 200 with revised H1, self-canonical, two standalone booking CTAs, $500,000 acquisition examples, and a live sitemap entry. Current sitewide gates pass with 1,301 canonical indexable URLs equal to 1,301 sitemap URLs; content quality scanned 1,988 HTML files with zero errors/warnings, broken internal links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0. IndexNow accepted the changed article and blog hub, 2/2, HTTP 200. Authenticated Search Console says the established URL is indexed, and its post-deployment live test says the updated version is available to Google, can be indexed, and has one valid breadcrumb. The owner-approved current sitemap resubmission later succeeded with Success and 1,301 discovered pages. Google's manual recrawl quota is exhausted for the day; the documented quota-limited fallback uses the live sitemap, internal links, and successful IndexNow submission. Although no exact-query impressions were observed, the acquisition basis, closing-statement, and paid study/return decision give this a credible premium buyer need rather than a generic credit definition. Count **80/100**; separate new-URL count **8/200** because this was an existing-canonical improvement. No public Google Indexing API was used.

### September 24, 2026 — Pending publication/indexing: S-corporation shareholder buyout funded with company cash

- Query: “Our S corporation used company cash to buy out a shareholder. Was it a redemption?”
- Premium-owner gate: The searcher is a continuing or departing owner of an operating company with a negotiated buyout, meaningful company cash at stake, shareholder basis exposure, and at least two owner returns plus Form 1120-S/K-1 coordination. AE's return and basis review is a plausible paid engagement. This is not a generic “what is an S corp?” question.
- Score: buyer and consultation intent **29/30** (the owners need a tax characterization before filing or amending); distinctness/canonical fit **24/25** (AE's shareholder-basis exit and distribution guides do not address who legally acquired a departing owner's shares when corporate cash funded the buyout); evidence **12/20** (the supplied organic-position export has broad S-corporation distribution and basis demand but no exact buyout row; the authenticated September 18–22 Search Console “buyout” filter showed one impression for a different management-buyout question and no exact shareholder-redemption query; current results include S-corporation buy-sell guidance from The Tax Adviser and CPA Journal plus real owner/practitioner questions about corporate-funded buyouts. The exact full wording is editorial synthesis, not measured volume); AE paid-service fit **15/15** (Form 1120-S, K-1, stock-basis, and correction review); authority/competitive gap **9/10** (the existing AE exit guide covers annual basis but no transaction-specific corporate-cash tracing). **Total: 89/100.**
- Decision: One genuinely distinct new canonical, `/blog/s-corp-shareholder-buyout-company-cash/`. The guide begins with a conditional answer, then compares cross-purchase, redemption, and corporate-funded personal purchase; models a $1 million co-owner exit and separate stock-basis blocks; sequences legal documents, cash, Form 1120-S/K-1 allocations, potential Section 1377 or qualifying-disposition election, documents, failure points, and return review. Two content-body “Book a Return Review Call” buttons stand alone and point to `/discovery/`; none interrupts a sentence. The existing exit-basis guide and blog index link to the new canonical.
- Primary sources: [IRS Form 7203 instructions](https://www.irs.gov/instructions/i7203), [IRS Form 1120-S instructions](https://www.irs.gov/instructions/i1120s), [IRS stock-and-debt-basis guidance](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-stock-and-debt-basis), and [26 USC §302 text via GovInfo](https://www.govinfo.gov/content/pkg/USCODE-2024-title26/html/USCODE-2024-title26-subtitleA-chap1-subchapC-partI-subpartA-sec302.htm). Competitor and owner discussions are used for query-pattern evidence, not tax authority.
- Validation and publication: commit `bbba7ec9` was pushed to main. The new guide passed 1,302/1,302 canonical/sitemap parity, content-quality errors/warnings 0 across 1,989 HTML files, broken internal links 0, date conflicts 0, invalid JSON-LD 0, scaled-content similarity errors/warnings 0 for this one new page, and `git diff --check` clean; the broader validator retains unrelated pre-existing legacy/staging metadata notices. Production returned HTTP 200 with the question-led H1, self-canonical, two standalone content-body `/discovery/` booking CTAs, primary IRS/Code sources, live sitemap entry, blog-card link, and an inbound exit-basis guide link. IndexNow accepted the new canonical and both changed supporting URLs, HTTP 200 (3/3). Authenticated Search Console's stored index says the new URL is unknown/not indexed; its fresh September 24 live test says “URL is available to Google,” “Page can be indexed,” and one valid breadcrumb item. The authenticated sitemap report still shows Success with 1,301 discovered pages from the previous submission, while the live XML now contains 1,302. **Pending:** action-time approval for a manual URL request and current sitemap resubmission; Google's manual request may be quota-limited. Do not increment either milestone until that final submission gate passes; IndexNow acceptance is not Google indexation.

### September 24, 2026 — Accepted target 77 and additional new URL 7: seller's study given to a rental buyer

- Query: “I bought a rental and the seller gave me their cost segregation study. Can I use it, or do I need my own?”
- Score: buyer/consultation intent **28/30** (a buyer is choosing a paid study scope and return position); distinctness **24/25** (AE's used-property bonus and study-evaluation guides do not answer whether seller records support the buyer's new basis); query evidence **12/20** (the supplied organic-position export shows AE at position 46 for the broad “cost segregation study” term, but not this exact question; authenticated Search Console showed only one impression for “seller” and no seller-study query in its September 18–22 window; current results contain buyer/seller study and acquisition-allocation discussions, so the complete wording is editorial synthesis, not a measured query); AE service fit **15/15** (cost segregation, valuation coordination, and return review); competitive gap **8/10** (buyer-specific reuse decision was absent from AE's index). **Total: 87/100.**
- Decision: New canonical `/blog/can-buyer-use-sellers-cost-segregation-study/`. This owns the buyer's question of what information in a seller's report can be reused and why the seller's depreciation numbers cannot be copied. It includes a five-step buyer-side review, a $1.4 million purchase example that reconciles land and furniture without duplicating basis, update-versus-new-work criteria, documents and failure points, current IRS sources, and two standalone `/discovery/` booking CTAs. The existing study-evaluation guide and blog hub link to it.
- Sources: [IRS Cost Segregation Audit Techniques Guide, Publication 5653](https://www.irs.gov/pub/irs-pdf/p5653.pdf), [IRS Publication 551](https://www.irs.gov/publications/p551), and [IRS Publication 946](https://www.irs.gov/publications/p946). Competitor/search-pattern evidence included current results for buyer/seller study and purchase-allocation questions; no exact search volume is claimed.
- Validation: content quality 0 errors/0 warnings; 1,299 canonical indexable URLs and 1,299 sitemap URLs; broken internal links 0; invalid JSON-LD 0; date conflicts 0; scaled-content similarity 0 errors/0 warnings for one new page. Full validator's unrelated legacy/staging metadata and duplicate-title notices remain unchanged.
- Publication: commit `73f0b004` pushed to `main`; rechecked September 24, the [live article](https://www.aetaxadvisors.com/blog/can-buyer-use-sellers-cost-segregation-study/) returned HTTP 200 with self-canonical, the $1.4 million purchase example, direct booking CTA, blog-hub link, and live sitemap entry. Current sitewide content quality passed with 1,301 canonical indexable URLs equal to 1,301 sitemap URLs and zero errors/warnings across 1,988 HTML files; broken internal links 0, date conflicts 0, invalid JSON-LD 0, and scaled-content errors/warnings 0. At publication, the similarity guard checked this new page specifically and found zero errors/warnings. IndexNow accepted the new article, blog hub, and related-study guide, 3/3, HTTP 200. Authenticated Search Console's indexed view says the URL is not yet on Google because it is newly unknown; the post-deployment live test says it is available to Google, can be indexed, and has one valid breadcrumb. The owner-approved current sitemap resubmission later succeeded with Success and 1,301 discovered pages. Google's manual indexing-request quota is exhausted for the day; under the documented quota-limited fallback, live sitemap discovery, internal links, and successful IndexNow submission complete the submission gate, but **not** actual Google indexation. This is a premium acquisition and basis-allocation decision for an owner considering a paid study scope, with a distinctive buyer-side fact pattern. Count **77/100** and **7/200** additional new URLs. No public Google Indexing API was used.
...
- Publication verification: commit `271f5fc5` deployed to both URLs; their live canonical tags, booking links, and production sitemap entries were verified. Content-quality, sitemap-parity, broken-link, JSON-LD, date-integrity, and scaled-content checks passed with no affected-page errors. IndexNow accepted both changed URLs (HTTP 200). Authenticated Search Console reports the owner URL indexed and its updated live page available to Google; the sitemap shows Success with 1,296 discovered pages. Manual recrawl and another sitemap submission await action-time approval.
...
- Publication verification: commit `95214502` deployed to both URLs; their live canonicals, direct `/discovery/` links, and entries in the 1,296-URL production sitemap were verified. Content quality, sitemap parity, broken-link, date-integrity, JSON-LD, and scaled-content checks passed with no affected-page errors. IndexNow accepted both changed URLs (HTTP 200). Authenticated Search Console reports the main guide indexed and its new live version available to Google; the supporting URL's older Google Index snapshot still points to a non-www alternate canonical, while the current live test says the corrected www page can be indexed. Manual recrawl requests await action-time approval; the sitemap is already submitted and shows Success, last read September 24, with 1,296 discovered pages.
