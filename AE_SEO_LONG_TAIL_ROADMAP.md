...
- Publication/indexing: pending deployment, production verification, IndexNow, and authenticated Search Console inspection/sitemap workflow. Do not increment the 67 accepted-target count before all gates are reported.
